...
;;   "Define a parser for matching metadata value"
;;   (%or
;;    ;; one or more metadata keys, each one having:
;;    (progn
;;      (%some (=destructure
